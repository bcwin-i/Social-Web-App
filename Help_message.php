<?php
	...
	$output .= '<input class="topic_title" id="user_name" placeholder="Name:" ><br>';
	$output .= '<input class="topic_title" type="email" id="Email" placeholder="Email:" ><br>';
	$output .= '<input class="topic_title" type="number" id="Mobile" placeholder="Mobile number:">';
